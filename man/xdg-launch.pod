...
B< xdg-launch> [I<OPTIONS>] [I<APPSPEC> [I<FILE>|I<URL>]...|I<COMMAND>]
 ...
 B<xdg-launch> {B<-X>|B<--xsession>}  [I<OPTIONS>] [I<APPID>|I<DESKTOP>|I<COMMAND>]
 B<xdg-launch> {B<-E>|B<--startup>}   [I<OPTIONS>] [I<APPID>|I<DESKTOP>|I<COMMAND>]
 B<xdg-launch> {B<-E>|B<--session>}   [I<OPTIONS>] [I<APPID>|I<DESKTOP>|I<COMMAND>]
...
=item I<APPSPEC> = {I<APPID>|I<MIMETYPE>|I<CATEGORY>|I<DESKTOP>}
