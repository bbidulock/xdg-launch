...
B< xdg-launch> [I<OPTIONS>] [I<APPSPEC> [I<FILE>|I<URL>]|B<-e> I<COMMAND>]
 B<xdg-launch> {B<-U>|B<--autostart>} [I<OPTIONS>] [I<APPID>|B<-e> I<COMMAND>]
 B<xdg-launch> {B<-X>|B<--xsession>}  [I<OPTIONS>] [I<APPID>|B<-e> I<COMMAND>]
 B<xdg-launch> {B<-E>|B<--session>}   [I<OPTIONS>] [I<APPID>|B<-e> I<COMMAND>]
 B<xdg-launch> {B<-h>|B<--help>} [I<OPTIONS>] [I<APPSPEC> [I<FILE>|I<URL>]|B<-e> I<COMMAND>]
