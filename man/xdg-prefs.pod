...
Some mime types are
F<application/x-designer>,
F<application/x-fluid>.

=item C<Profiling;Development>

A profiling tool.
No commonly known tools or mime types.

=item C<RevisionControl;Development>

Applications like cvs or subversion.
No commonly known mime types.  Some examples are F<bzr-explorer.desktop> and
there should be a F<gitk.desktop>.

=item C<Translation;Development>

A translation tool.
Only tool I know of is F<linguist.desktop> with mime types
F<text/vnd.trolltech.linguist> and F<application/x-linguist>.
