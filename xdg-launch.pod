...
desktop entry instead of an C<Application> desktop entry.  Aside from
this difference, the launcher operates in the same fashion.  This option
is intended for launching window managers.
